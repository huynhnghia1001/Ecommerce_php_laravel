...
(function ($) {
  ...
  var $text_sm_brand_checkbox = $('<input />', {
    type: 'checkbox',
    value: 1,
    checked: $('.brands-link').hasClass('text-sm'),
    class: 'mr-1'
  }).on('click', function () {
    if ($(this).is(':checked')) {
      $('.brands-link').addClass('text-sm')
    } else {
      $('.brands-link').removeClass('text-sm')
    }
  })
  ...
  // $('.brands-link')[0].classList.forEach(function (className) {
