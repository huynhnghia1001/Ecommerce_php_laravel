                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input readonly type="text" name="slug" id="slug" class="form-control" value="{{$brands->slug}}" placeholder="Slug">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        <option {{($brands->status == 1 )? 'select' : ''}} value="1">Active</option>
                                        <option {{($brands->status == 0 )? 'select' : ''}} value="0">Block</option>
                                    </select>
                                </div>
                            </div>
                        </div>
