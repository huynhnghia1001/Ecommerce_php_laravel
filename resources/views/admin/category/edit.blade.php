                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" readonly name="slug" value="{{$category->slug}}" id="slug" class="form-control"
                                        placeholder="Slug">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div id="image" class="dropzone dz-clickable">
                                        <div class="dz-mesage needsclick">
...
@section('customJs')
    <script>
        ...
        const dropzone = $("#image").dropzone({
            ...
            paramName: 'image',
            addRemoveLinks: true,
            acceptedFiles: "image/jpeg,image/png,img/gif",
            headers: {
