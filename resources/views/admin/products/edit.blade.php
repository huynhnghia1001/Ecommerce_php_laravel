                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input readonly type="text" value="{{$product->slug}}" name="slug" id="slug"
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <div class="custom-control custom-checkbox">
                                                {{--                                            <input type="hidden" type="checkbox" name="track_qty" value="no" >--}}
                                                <input class="custom-control-input" value="yes" type="checkbox"
                                                       id="track_qty" name="track_qty"
                                                       {{($product->track_qty == 'yes') ? 'check' : ''}} checked>
                                        ...
                                        <div class="mb-3">
                                            <input type="number" min="0" name="qty" id="qty" value="{{$product->qty}}"
                                    ...
                                    <select multiple class="related-product w-100" name="related_products[]"
                                        ...
                                        @if(!empty($relatedProducts))
                                            @foreach($relatedProducts as $relProduct)
                                                <option selected
                                                        value="{{$relProduct->id}}">{{$relProduct->title}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    <p class="error"></p>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="sub_category" id="sub_category" class="form-control">
                                        ...
                                        @foreach($sub_categories as $subcategory)
                                            <option
                                                {{ ($product->sub_category_id == $subcategory->id) ? 'selected' : '' }} value="{{$subcategory->id}}">
                                                {{$subcategory->name}}
                                            </option>
                                        @endforeach
                                    </select>
    ...
    <script>
        ...
        const dropzone = $("#image").dropzone({
            ...
            headers: {
                ...
                const html = `<div class="col-md-3" id="image-row-${response.image_id}"><div class="card">
