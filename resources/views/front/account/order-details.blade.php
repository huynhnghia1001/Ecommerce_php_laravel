                ...
                <div class="col-md-9">
                    <div class="card">
                        ...
                        <div class="card-footer p-3">
                            ...
                            <!-- Heading -->
                            <h6 class="mb-7 h5 mt-4">Order Items ({{$countOrder}})</h6>
                                        ...
                                        <li class="list-group-item">
                                            <div class="row align-items-center">
                                                <div class="col-4 col-md-3 col-xl-2">
                                                    ...
                                                    {{--                                                                                class="img-fluid"></a>--}}
                                                    @php
                                                        $productImage = getProductImage($orderDetail->product_id);
                                                    @endphp
                                                ...
                                                <div class="col">
                                                    ...
                                                    <p class="mb-4 fs-sm fw-bold">
                                                        <a class="text-body" href="product.html">{{$orderDetail->name}}
                                                            x {{$orderDetail->qty}}</a> <br>
                                                        <span class="text-muted">${{number_format($orderDetail->total,2)}}</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </li>
