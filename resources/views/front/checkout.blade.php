                        ...
                        <div class="card cart-summery">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mt-2">
                                    ...
                                    <div class="h6"><strong
                                            id="shippingAmount">${{number_format($totalShippingCharges,2)}}</strong>
                                    </div>
                                </div>
                        ...
                        <div id="discount-response-wrapper">
                            @if(Session::has('code'))
                                <div class="mt-4" id="discount-response">
                                    ...
                                    <a class="btn btn-sm btn-danger" id="remove-discount"><i class="fa fa-times"></i>
                                    </a>
                                </div>
                            @endif
                        </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == true) {
                        $("#shippingAmount").html(response.shippingCharges);
